...
from book_configuration import book_import, book_text_cleaning
...
class LiviaApp:
    def __init__(self, root):
        ...
        create_button(self.master, "Import text from url", self.import_from_url, 'place', {'x': 5, 'y': 65})
        create_button(self.master, "Add new flashcards", self.new_word_input, 'place', {'x': 5, 'y': 95})
        create_button(self.master, "Start course", self.start_learning, 'place', {'x': 5, 'y': 125})
        create_button(self.master, "Start reading", self.start_reading, 'place', {'x': 5, 'y': 155})
